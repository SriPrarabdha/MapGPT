...
from vln.gpt_multi_agent import MultiAgentGPTNavAgent  # Updated import
...
async def valid(args, val_envs, rank=0):
    default_gpu = None
    agent_class = MultiAgentGPTNavAgent
    ...
    for env_name, env in val_envs.items():
        ...
        print('running...')
        await agent.test(args=args)  # Updated to await
...
async def main():
    ...
    await valid(args, val_envs)  # Updated to await

if __name__ == '__main__':
    asyncio.run(main())  # Updated to use asyncio.run